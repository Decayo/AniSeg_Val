...
class AniSeg(BaseDataset):
    def __init__(self, setting, split_name, preprocess=None,
        ...
        super(AniSeg, self).__init__(setting, split_name, preprocess, file_length)
    ...
    def get_class_colors(*args):
        ...
        return [[0, 0, 0],[255, 0, 0], [255, 0, 255], [255, 255, 0], [225, 97, 0],
                ...
                [127, 255, 0],
                [34, 139, 34], [8, 46, 84], [64, 224, 208],
                [176, 226, 255],
                [139, 101, 8], [139, 101, 8], [139, 101, 8],
                [74, 112, 139]]
    ...
    def get_class_names(*args):
        ...
        return ['00_unlabeled','01_hair', '02_hair_decoration', '03_face', '04_eyes','05_mouth',
                ...
                '12_legs',
                '13_feet', '14_leg assessories', '14_leg assessories',
                '16_shoes',
                ]
